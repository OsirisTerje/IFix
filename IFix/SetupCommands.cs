...
//        public SetupCommands(Parser parser)
//        {
//            this.parser = parser;
...
//            SetupVSTestCache();
//            SetupGoToBlog();
//            //parser.Setup("?", "help").Callback(text => HelpText = text);  //Console.WriteLine(text));
//        }

//        public void SetupGoToBlog()
//        {
//            var setup = parser.Setup<GoToBlog>("info").Callback(Execute);
